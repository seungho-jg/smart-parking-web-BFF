...
const API_BASE_URL = "http://10.10.108.155:8080";
...
const reserveParkingSpace = async (action, spaceId) => {
...
function Home() {
  ...
  const [parkingSpaces, setParkingSpaces] = reactExports.useState([]);
  const [selectedFloor, setSelectedFloor] = reactExports.useState(FLOORS[0]);
  ...
  const renderParkingSpaces = (floor) => {
    ...
    if (loading) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center p-4", children: "로딩 중..." });
    if (error2) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center p-4 text-red-500", children: error2 });
    return rows.map((row, rowIndex) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center items-center my-5", children: row.map((space) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        className: `w-16 h-24 m-1 flex flex-col items-center justify-center rounded-lg text-white transition-colors ${getStatusColor(space.status)} ${space.status === "AVAILABLE" ? "cursor-pointer" : ""}`,
        onClick: () => handleSpaceClick(space),
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold", children: space.name })
      },
      space.id
    )) }, rowIndex));
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold mb-4 text-center", children: "실시간 주차 현황" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center mb-4", children: FLOORS.map((floor) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: () => setSelectedFloor(floor),
        className: `px-4 py-2 mx-2 rounded-md transition-colors ${selectedFloor === floor ? "bg-blue-500 text-white" : "bg-gray-200 text-gray-700 hover:bg-gray-300"}`,
        children: `${floor}층`
      },
      floor
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gray-100 p-4 rounded-lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center", children: renderParkingSpaces(selectedFloor) }) })
  ] });
}
function Reservations() {
  ...
  const handleReservation = async (e) => {
    ...
    try {
      ...
      alert(error2.message || "예약에 실패했습니다.");
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold mb-4", children: "주차 예약" }),
    spaceId ? /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleReservation, className: "max-w-md mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg", children: [
        "선택한 주차 공간: ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: spaceName })
      ] }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "예약할 주차 공간을 먼저 선택해주세요." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: () => navigate("/"),
          className: "mt-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline",
          children: "주차 현황으로 돌아가기"
        }
      )
    ] })
  ] });
...
function MyPage() {
  const [parkingHistory, setParkingHistory] = reactExports.useState([]);
  const [loading, setLoading] = reactExports.useState(true);
  const [error2, setError] = reactExports.useState(null);
  reactExports.useEffect(() => {
  ...
  if (error2) return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center p-4 text-red-500", children: error2 });
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold mb-4", children: "마이페이지 - 주차 이력" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "min-w-full bg-white shadow-md rounded-lg", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-gray-200", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "py-2 px-4 border-b", children: "주차 공간" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "py-2 px-4 border-b", children: "입차 시간" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "py-2 px-4 border-b", children: "출차 시간" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "py-2 px-4 border-b", children: "주차 요금" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: parkingHistory.length > 0 ? parkingHistory.map((record) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-4 border-b", children: record.spaceName }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-4 border-b", children: new Date(record.entryTime).toLocaleString() }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-4 border-b", children: record.exitTime ? new Date(record.exitTime).toLocaleString() : "-" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 px-4 border-b", children: `${record.parkingFee.toLocaleString()}원` })
      ] }, record.id)) : /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: "4", className: "text-center py-4", children: "주차 이력이 없습니다." }) }) })
    ] }) })
  ] });
}
...
function Login() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center justify-center min-h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit, className: "bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-gray-700 text-sm font-bold mb-2", htmlFor: "id", children: "아이디" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-gray-700 text-sm font-bold mb-2", htmlFor: "password", children: "비밀번호" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
...
function SignUp() {
  ...
  const [vehicle_number, setVehicle_number] = reactExports.useState("");
  const [password, setPassword] = reactExports.useState("");
  const onSubmit = async (e) => {
    e.preventDefault();
    ...
    try {
      ...
      alert(error2.message || "회원가입에 실패했습니다.");
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center justify-center min-h-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit, className: "bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-gray-700 text-sm font-bold mb-2", htmlFor: "name", children: "이름" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          className: "shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-gray-700 text-sm font-bold mb-2", htmlFor: "vehicle_number", children: "차량번호" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          className: "shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline",
...
const BottomNav = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "fixed bottom-0 left-0 right-0 bg-white shadow-t-md", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-around max-w-screen-sm mx-auto", children: navItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    Link,
    {
      to: item.path,
      className: `flex flex-col items-center justify-center w-full pt-2 pb-3 text-sm ${location.pathname === item.path ? "text-blue-600" : "text-gray-500"}`,
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pb-16", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/reservations", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Reservations, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/my-page", element: /* @__PURE__ */ jsxRuntimeExports.jsx(MyPage, {}) }),
